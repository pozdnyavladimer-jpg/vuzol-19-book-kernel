...
## v0.3 scaling experiment

Added:

```text
vuzol_reasoning/scaling.py
experiments/scaling_local_repair.py
tests/test_scaling_curve.py
experiments/results/local_repair_scaling.json
experiments/results/local_repair_scaling.csv
experiments/results/SCALING_REPAIR_REPORT.md
experiments/plots/local_repair_scaling_curve.png
experiments/plots/local_repair_fraction.png
```

Measured balanced-tree series:

```text
27  -> 3 ancestor recomputations
81  -> 4
243 -> 5
729 -> 6
```

This is a controlled structural result, not yet a claim about arbitrary reasoning graphs.
