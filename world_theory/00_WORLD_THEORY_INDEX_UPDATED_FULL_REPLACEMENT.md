...
BINDU_VERDICT:
  ...
  reason:
    - "files 66–70 form a complete civilizational layer"
    - "AI needs them in reading order to use them as canon"
    - "without index, they exist as files but not as active runtime memory"
  ...
  next_step:
    ...
    - "then add scene seeds using 66–70"
```
